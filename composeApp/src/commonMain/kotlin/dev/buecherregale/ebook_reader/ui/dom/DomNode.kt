...
fun DomNode(
    ...
    when (node) {
        ...
        is Heading -> DomHeading(book, node, config, modifier, onTextSelected = onTextSelected)
        ...
        is Link -> DomLink(book, node, config, modifier, onTextSelected = onTextSelected)
        is Ruby -> DomRuby(book, node, config, modifier, onTextSelected = onTextSelected)
